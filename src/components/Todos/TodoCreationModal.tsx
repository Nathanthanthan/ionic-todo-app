...
export default function TodoCreationModal({ isOpen, setIsOpen, onSubmit }: Props) {
...
function TodoCreationModalContent({ setIsOpen, onSubmit, didPresent }: ContentProps) {
